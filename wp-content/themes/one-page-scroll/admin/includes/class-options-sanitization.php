...
/**
 * Sanitization for css code textarea field
 *
 * @param $input string
 * @return $output sanitized string
 */
function of_sanitize_css( $input ) {

	$output = wp_filter_nohtml_kses( $input );
	return $output;
}
add_filter( 'of_sanitize_css', 'of_sanitize_css' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'onepagescroll' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'onepagescroll' ),
		'repeat-y'  => __( 'Repeat Vertically', 'onepagescroll' ),
		'repeat'    => __( 'Repeat All', 'onepagescroll' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'onepagescroll' ),
		'top center'    => __( 'Top Center', 'onepagescroll' ),
		'top right'     => __( 'Top Right', 'onepagescroll' ),
		'center left'   => __( 'Middle Left', 'onepagescroll' ),
		'center center' => __( 'Middle Center', 'onepagescroll' ),
		'center right'  => __( 'Middle Right', 'onepagescroll' ),
		'bottom left'   => __( 'Bottom Left', 'onepagescroll' ),
		'bottom center' => __( 'Bottom Center', 'onepagescroll' ),
		'bottom right'  => __( 'Bottom Right', 'onepagescroll')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'onepagescroll' ),
		'fixed'  => __( 'Fixed in Place', 'onepagescroll')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'onepagescroll' ),
		'italic'      => __( 'Italic', 'onepagescroll' ),
		'bold'        => __( 'Bold', 'onepagescroll' ),
		'bold italic' => __( 'Bold Italic', 'onepagescroll' )
		);
